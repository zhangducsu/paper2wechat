...
- 解读文本必须符合中文读者的用词、语序和表达习惯，避免逐词硬译英文句子。
- 专业术语保留准确性，但解释句要使用自然中文表达，例如“这提示……”优先于“This suggests that”的直译。
- 专业英文缩写首次出现时，必须用括号给出英文全称；如有成熟中文译名，格式为“中文译名（英文全称，英文缩写）”。
- 疑似中文拼音作者名、单位或团队名称，只有在网络检索到论文页、机构主页、作者主页、ORCID、Google Scholar、新闻稿等可靠来源时，才可翻译为中文姓名。
- 无法通过网络检索核验的作者姓名必须保留英文原文，不得根据拼音猜测中文名。
- 已核验的中文姓名应在文中自然使用；首次出现可写作“中文名（英文署名）”，后文使用中文名或“研究团队”。
